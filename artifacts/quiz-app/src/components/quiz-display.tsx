        ...
        <Card key={q.id || index} className="overflow-hidden border-border/60">
          <CardHeader className="bg-muted/30 pb-4">
            <div className="flex items-start justify-between">
              ...
              } className="ml-4 shrink-0 capitalize">
                {q.difficulty}
              </Badge>
            </div>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            {q.hasEquation && q.equations && q.equations.length > 0 && (
              <div className="space-y-2 my-4 p-4 bg-muted/20 rounded-md overflow-x-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {q.options.map((opt, i) => {
                  ...
                  return (
                    ...
                    >
                      <span className={`font-medium min-w-[24px] ${isCorrect ? 'text-primary' : 'text-muted-foreground'}`}>{letter}.</span>
            ...
            <div className="mt-6 pt-4 border-t space-y-4">
              {q.type !== 'mcq' && (
                <div>
                  <h4 className="font-semibold text-sm text-muted-foreground uppercase tracking-wider mb-1">Correct Answer</h4>
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed bg-muted/40 p-4 rounded-md text-foreground">
                  {q.explanation}
                </p>
              </div>
            </div>
